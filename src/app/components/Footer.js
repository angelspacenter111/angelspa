...
const Footer = () => {
    return (
        <>
            <div className="sitemap" style={{ visibility: 'visible', animationDelay: '1.1s' }}>
                <Link href="/">Home</Link> | <Link href="/about">about us</Link> | <Link href="/contact">contact</Link> | <Link href={"/swedish-massage-center-near-me-in-mumbai"}>Swedish Massage</Link> | <Link href={"/thai-massage-center-near-me-in-mumbai"}>Thai Massage</Link> | <Link href={"/deep-tissue-massage-center-near-me-in-mumbai"}>Deep Tissue Massage</Link> | <Link href={"/best-head-massage-center-in-mumbai-angel-spa"}>Head Massage</Link> | <Link href={"/best-face-massage-service-in-andheri"}>Face Massage</Link> | <Link href={"/best-aromatherapy-massage-center-in-mumbai-angel-spa"}>Aromatherapy Massage</Link> | <Link href={"/best-spa-centre-in-mumbai"}>Spa Center</Link> | <Link href={"/best-hot-stone-massage-mumbai"}>Hot Stone Massage</Link> | <Link href={"/best-couple-massage-mumbai"}>Couple Massage</Link> |
            </div>
