...
let pageUrl = base_url + "/swedish-massage-center-near-me-in-mumbai";
...
const page = () => {
    return (
        <>
            <Header />
            <main>
                <Breadcrumb pagename="Swedish Massage" />
